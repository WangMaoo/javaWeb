...
<div class="container" style="width: 400px;">
    ...
    <form action="/contact" method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" id="qq" value="${contact.qq}" class="form-control" name="qq" placeholder="请输入QQ号码"/>
        </div>

        <div class="form-group">
            <label for="email">Email：</label>
            <input type="text" id="email" value="${contact.email}" class="form-control" name="email" placeholder="请输入邮箱地址"/>
        </div>
